...
RUN apt-get update -qqy \
    ...
    && apt install -qqy unzip vim nano neovim openjdk-11-jdk python3 python3-pip npm neofetch hollywood \
    && apt update -qqy \
    && apt upgrade -qqy \
    && apt-get autoclean \
    && apt-get autoremove \
...
# Additional configuration steps or software installations can be added here
